...
import { orderDetail } from "../../Reudx/action";
  ...
  return (
    <div>
      {loading ? (
        ...
        <div className="w-90% h-[400px] bg-slate-100 m-10 rounded-md">
          <div className="flex flex-row flex-2 items-center flex-nowrap">
            ...
            <div className="p-4 w-[900px] h-[200px]  ml-10">
              <p>Name : {order?.orderItems[0]?.product?.name}</p>
              <span className="">
                Description : {order?.orderItems[0]?.product?.description}
              </span>
              <p className="">Color : {order?.orderItems[0]?.product?.color}</p>
              <p className="">
